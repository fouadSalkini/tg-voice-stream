class TEXTS:
    ...
    BOOTED = (
        "#START\n\n"
        "**{0} is alive!**\n\n"
        "__» Voice-Streaming Version:__ `{1}`\n"
    ...
    SOURCE = (
        ...
        "__» Every project available under Voice-Streaming are open-source and free to use and modify to your needs.__\n"
